...
-----------
    ...
    python src/pipeline/eval/memory_injection_diag.py \
...
import pipeline.eval.oracle_injection as _oracle_mod  # noqa: E402（设置 _SIZE_HW / _ORACLE_CLIP_FRAMES）

# 复用：eval_ablation 的 trainer/model 加载（= train_v4 load_models + retrieval_probe ft 加载）
from pipeline.eval.eval_ablation import (  # noqa: E402
